...
const FindRide = () => {
  ...
  return (
    <div className="p-4 pb-20 bg-purple-50 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
      <h2 className="text-2xl font-semibold mb-4 text-purple-900 dark:text-purple-100">Find a Ride</h2>
      <form onSubmit={handleFind}>
        <div className="mb-4 relative">
          <label htmlFor="from" className="block text-sm font-medium text-purple-700 dark:text-purple-300">From</label>
          <input
            type="text"
            id="from"
            value={fromLocation}
        ...
        <div className="mb-4 relative">
          <label htmlFor="to" className="block text-sm font-medium text-purple-700 dark:text-purple-300">To</label>
          <input
            type="text"
            id="to"
            value={toLocation}
        ...
        <div className="mb-4 relative">
          <label htmlFor="onboarding" className="block text-sm font-medium text-purple-700 dark:text-purple-300">Onboarding Point</label>
          <input
            type="text"
            id="onboarding"
            value={onboarding}
        ...
        <div className="mb-4">
          <label htmlFor="findTime" className="block text-sm font-medium text-purple-700 dark:text-purple-300">Time</label>
          <input type="time" id="findTime" value={time} onChange={(e) => setTime(e.target.value)} className="mt-1 p-2 w-full border border-purple-600 dark:border-purple-700 rounded-md bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-200 placeholder-purple-600 dark:placeholder-purple-300 focus:border-purple-700 dark:focus:border-purple-300 focus:ring-purple-700 dark:focus:ring-purple-300" />
        </div>
        <div className="mb-4">
          <label htmlFor="maxPrice" className="block text-sm font-medium text-purple-700 dark:text-purple-300">Max Price</label>
          <input type="number" id="maxPrice" value={maxPrice} onChange={(e) => setMaxPrice(e.target.value)} placeholder="Enter max fare" className="mt-1 p-2 w-full border border-purple-600 dark:border-purple-700 rounded-md bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-200 placeholder-purple-600 dark:placeholder-purple-300 focus:border-purple-700 dark:focus:border-purple-300 focus:ring-purple-700 dark:focus:ring-purple-300" />
        </div>
        <button type="submit" className="bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md">Find Ride</button>
      </form>
      <RideList rides={ridesWithAddresses} />

      {ridesWithAddresses.length === 0 && foundRides.length !== undefined && (<div className="mt-4 text-purple-600 dark:text-purple-300">No rides found.</div>)}
    </div>
  );
};
