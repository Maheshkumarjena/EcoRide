      ...
      <form onSubmit={handleFind}>
        <div className="mb-4 relative">
          ...
          <input
            ...
            className="mt-1 p-2 w-full border border-purple-600 dark:border-purple-700 rounded-md bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 placeholder-purple-600 dark:placeholder-purple-300 focus:border-purple-700 dark:focus:border-purple-300 focus:ring-purple-700 dark:focus:ring-purple-300"
          />
...
<h2 className="text-xl font-bold text-purple-900 dark:text-purple-100">
  Choose the Ride that suits you the best!
</h2>
<p className="text-purple-700 dark:text-purple-300">One step closer towards saving the earth</p>
