    ...
    <>
      <div className="fixed bottom-0 h-[10vh] z-50 w-full -translate-x-1/2 left-1/2 bg-opacity-30 bg-clip-padding backdrop-filter backdrop-blur-sm border-t border-purple-300 dark:border-purple-700">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
          <Link href="/" className="inline-flex flex-col items-center justify-center p-4 hover:bg-purple-300 dark:hover:bg-purple-800 group cursor-pointer">
          ...
          <Link href="/Ride" className="inline-flex flex-col items-center justify-center p-4 hover:bg-purple-300 dark:hover:bg-purple-800 group cursor-pointer">
          ...
          <Link href="/Search" className="inline-flex flex-col items-center justify-center p-4 hover:bg-purple-300 dark:hover:bg-purple-800 group cursor-pointer">
          ...
          <Link href="/menu" className="inline-flex flex-col items-center justify-center p-4 hover:bg-purple-300 dark:hover:bg-purple-800 group cursor-pointer">
            ...
            <span className="text-xs text-purple-800 dark:text-purple-200 group-hover:transform group-hover:scale-110 transition-all duration-200 ease-in-out">Menu</span>
          </Link>
