      ...
      {user ? (
        ...
        <div className="flex space-x-2">
          ...
          <Link href='/SignUp'>
            <button
              onClick={onSignUp}
              className="sm:px-4 cursor-pointer sm:py-2 bg-purple-400 text-white rounded-md hover:bg-purple-300 hover:scale-105 transition-transform duration-200 flex items-center gap-2 text-sm dark:bg-purple-600 dark:text-white hover:brightness-110 px-2 py-[8px] text-xs"
            >
